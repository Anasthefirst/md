  ...
  function PistolItem() {
    ...
    function entityRayCast(player, world, range) {
      ...
      if (rayTraceResult != null){
        return {entity: rayTraceResult, headshot: isHeadshot, hitVec: targetPosition};
      } else{
        return null;
      }
    }
    ...
    nmi_ItemPistol.prototype.$onItemRightClick = function ($itemstack, $world, $player) {
      ...
      if (shotentitydata != null){
        if (!world.isRemote) {
          ...
          world.createExplosion(null, shotentitydata.hitVec.x, shotentitydata.hitVec.y, shotentitydata.hitVec.z, 4.0, true);
